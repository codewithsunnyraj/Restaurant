...
const Cart = () => {
  ...
  return (
    <div className="container mx-auto lg:mx-auto ">
      <div className="">
        <div className=" my-4  md:mt-20 grid grid-cols-6  font-semibold">
          <p>Items</p>
          <p>Title</p>
          <p>Price</p>
          <p>Quantity</p>
            ...
            return (
              <>
                <div className="grid grid-cols-6 space-y-3 border-b-2 ">
                  <img src={items.image} className="w-16 my-2" alt="" />
                  <p>{items.name}</p>
                  <p>${items.price}</p>
      ...
      <div className="grid grid-cols-2 mt-5 md:mt-20">
        <div>
          <div className="">
        ...
        <div className="place-items-center">
          <div>
            ...
            <div className="border-2  rounded-md bg-[#eaeaea]">
              <input
                type="text"
